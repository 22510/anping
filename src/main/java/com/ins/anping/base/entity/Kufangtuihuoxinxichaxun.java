...
@ApiModel(value="Kufangtuihuoxinxichaxun对象", description="库房退货信息查询")
public class Kufangtuihuoxinxichaxun implements Serializable {
    ...
    @ApiModelProperty(value = "收货人联系")
    @TableField("ShouHuoRenLianXi")
    private String shouhuorenlianxi;
