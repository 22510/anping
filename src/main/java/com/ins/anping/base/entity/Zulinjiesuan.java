...
@ApiModel(value="Zulinjiesuan对象", description="租赁结算")
public class Zulinjiesuan implements Serializable {
    ...
    @ApiModelProperty(value = "总计运费")
    @TableField("ZongJiYunFei")
    private String zongjiyunfei;
