...
@ApiModel(value="Tuihuoxinxichaxun对象", description="退货信息查询")
public class Tuihuoxinxichaxun implements Serializable {
    ...
    @ApiModelProperty(value = "未收退货件数")
    @TableField("WeiShouTuiHuoJianShu")
    private String weishoutuihuojianshu;
